...
namespace IdentityServer
{
    public static class IdentityServerConfig
    {
        ...
        public static IEnumerable<ApiResource> GetApiResources()
        {
            ...
            {
                new ApiResource("AdminGet", "Admin Get", new List<string>{ JwtClaimTypes.Role }),
                new ApiResource("UserGet", "User Get", new List<string>{ JwtClaimTypes.Role })
            };
        }
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            ...
            {
                new ApiScope(name: "AdminGet",   displayName: "Admin action"),
                new ApiScope(name: "UserGet",  displayName: "User action")
            };
        }
    }
